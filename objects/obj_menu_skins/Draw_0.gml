...
draw_text_transformed(room_width/2, 80, "GALERIA DE SKINS", 2, 2, 0);
...
var _txt_modelo = "Modelo: < " + opcoes_skin[selecao_atual] + " >";
draw_text_transformed(_x_centro, _y_centro + 180, _txt_modelo, 1.5, 1.5, 0);

// Rodapé de instrução
draw_set_color(c_ltgray);
draw_text(_x_centro, room_height - 50, "Aperte ESPAÇO para Confirmar e Voltar");
